...
| **Cài đặt lớp** (tab thứ 3, chỉ giáo viên) | Tên, phần/khoá · **ảnh đại diện lớp** (tự thu nhỏ còn 320 px, lưu ở Storage `classes/<id>/`) · **tâm trạng lớp**: Vui vẻ, Phấn khích, Quyết tâm, Tập trung, Bình yên, Mệt mỏi, Buồn, Thất vọng — đổi màu đầu trang lớp, biểu cảm và câu nói của i-melts (sửa danh sách ở `js/classes/themes.js`) · bật/tắt duyệt · khoá không nhận thêm · đặt lại mã · lưu trữ |
